...
$total_resultados = mysqli_num_rows($result_inventario);
    ...
    <tr class="uppercase">
        ...
        <td>
            <?php if ($inventario['prestamoResponsiva'] == "") { ?>
                ...
                <a href="home_actions.php?id_cartaFirmada=<?php echo $inventario['idInventario'] ?>" class="capitalize">Subir archivo</a>
            <?php
            } else { ?>
